# Reproducibility package for manuscript 4416781, second revision

Extra Hidden States under Emission Misspecification in Hidden Markov Models.
Prepared 17 September 2026. This complete package contains the data, code,
fitted objects and documents accompanying the revised article.
...
The original elk work is retained as supplementary sensitivity and negative
results. Its reproduction sequence follows below.
...
The simulation estimates, associated figures and tables, and refinement
likelihood-ratio bootstrap are updated with the computational checks described
below. The primary genomic and supplementary movement estimates are retained.

## Reproduce the preserved Gaussian benchmark
...
## Reproduce the expanded movement analysis
...
## Supplementary movement computations

`numerics/scripts/run_elk_application.R`, `empirical/output/` and the older
empirical figures preserve the first-revision computation and support its
comparison. They are not the source of the revised application tables.
